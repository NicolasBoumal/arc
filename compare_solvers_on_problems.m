...
solvers_and_options = {struct('solver', @trustregions, 'name', 'RTR'), ...
                       struct('solver', @arc, 'theta', .50, 'subproblemstop', 'sqrule', 'subproblemsolver', @arc_lanczos, 'name', 'ARC (Lanczos)'), ...
                 ...
                 ... % struct('solver', @arc, 'gamma_1', 0.0, 'gamma_2', 5, 'theta', .25, 'subproblemstop', 'sqrule', 'subproblemsolver', @arc_conjugate_gradient, 'name', 'ARC (NLCG, \theta = .25, sqrule, gamma_1 = 0.0, gamma_2 = 5)'), ...
                       struct('solver', @arc, 'gamma_1', 0.1, 'gamma_2', 2, 'theta', .25, 'subproblemstop', 'sqrule', 'subproblemsolver', @arc_conjugate_gradient, 'name', 'ARC (NLCG)'), ...
